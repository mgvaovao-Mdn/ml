...
para(doc,
    ...
    "restitution final et la participation à une conférence régionale. Les frais généraux sont "
    "limités à 5 % (10 500 USD), reflétant la structure légère de l'organisation. La frugalité "
    "est un principe de conception : le coût opérationnel mensuel en production est estimé à "
    "environ 42 USD, garantissant la pérennité du service après la fin du financement.")
